export const Icons = {
  ...
  // Добавьте эти иконки в существующий файл Icons.tsx
  ...
  // Document icon (for general sections)
  ...
  // Analytics icon (for Google Adsense)
